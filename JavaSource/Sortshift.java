// THIS IS A SPECIAL VERSION TO TEST SHIFTING INSTEAD OF DIVIDING.
...
static void Sort(Integer[] A) {
  ...
  System.out.println("Sorting in " + 16/THRESHOLD + " passes");
  radix(A, temp, 32/THRESHOLD, POW2[THRESHOLD], count);
}
...
static void radix(Integer[] A, Integer[] B,
  ...
  for (i=0, rtok=0; i<k; i++, rtok+=THRESHOLD) { // For k digits
