...
public static void main(String args[]) throws IOException {
  ...
  for (i=1; i<filelength/4; i++) {
    ...
    // WARNING: This does NOT match what the sort really did (it sorts 4-byte int keys),
    // though the results do look reasonable for some purposes.
    int dum1 = Val2 >> 16;
    int dum2 = Val2 & 0xffff;
    if(((i-1)%1024)==0) System.out.format("%5d %5d  ", dum1, dum2);
