...
\newcommand{\Bool} {\Cref{boolean}}
\newcommand{\Gen} {generic}
\newcommand{\Gens} {generics}
\newcommand{\GGens} {Generics}
\newcommand{\gpp} {\mbox{\textbf{g\lower2pt\hbox{$^{++}$}}}}
\newcommand{\CPPsf} {\mbox{\sffamily\textbf{C\lower2pt\hbox{$^{++}$}}}}
...
\newcommand{\lang} {\mbox{java}}
\newcommand{\Lang} {\mbox{Java}}
\newcommand{\LangJava} {\mbox{Java}}
\newcommand{\Langsf} {\mbox{\sffamily\textbf{Java}}}
\newcommand{\LangJavasf} {\mbox{\sffamily\textbf{Java}}}
...
\newcommand{\pointref}{reference}
\newcommand{\pointrefs}{references}
...
\newcommand{\xprogfig}[1]{{\small\verbinput{../SRC/#1}}}

% Put in line numbers
\newcommand{\xprogline}[1]{{\small\verbinputnum{../SRC/#1}}}

\newcommand{\xproghere}[1]{{\bigskip\setlength{\parindent}{0in}
                            \begin{minipage}{5in}\small
                            \verbinput{../SRC/#1}\end{minipage}\bigskip}}
...
\smallskip
\Large Edition 3.2 (Java Version)}
...
(see {\small\url{http://store.doverpublications.com/0486485811.html}}).\\
...
%\includeonly{preface,intro,mathpre,alganal,list,bintree,gentree,insort,fileproc,search,indexing}
...
\include{preface}\mycleardoublepage

\pagenumbering{arabic}
\include{intro}\mycleardoublepage     % Quote
\include{mathpre}\mycleardoublepage   % Quote
\include{alganal}\mycleardoublepage   % Quote
\include{list}\mycleardoublepage      % Note about Polya quote
\include{bintree}\mycleardoublepage   % No quote
\include{gentree}\mycleardoublepage   % No quote
\include{insort}\mycleardoublepage    % No quote
\include{fileproc}\mycleardoublepage  % No quote
\include{search}\mycleardoublepage    % Quote
\include{indexing}\mycleardoublepage  % No quote
\include{graphs}\mycleardoublepage    % No quote
\include{relist}\mycleardoublepage    % No quote
\include{advtree}\mycleardoublepage   % No quote
\include{analtech}\mycleardoublepage  % Quote
\include{bounds}\mycleardoublepage    % No quote
\include{algorithms}\mycleardoublepage % No quote
\include{limcomp}\mycleardoublepage   % No quote
